...
REM Desktop soft-lock overlay: ordinary idle lock without pausing background apps.
IF "%MG_IDLE_TIMEOUT%"=="" SET MG_IDLE_TIMEOUT=90
IF "%MG_PASSIVE_FPS%"=="" SET MG_PASSIVE_FPS=0
...
REM Service DetectionResult bridge is default-off until service-only tests.
IF "%MG_ENABLE_SERVICE_IPC%"=="" SET MG_ENABLE_SERVICE_IPC=0
...
IF "%MG_SOFT_LOCK_VERIFY_WINDOW_SECONDS%"=="" SET MG_SOFT_LOCK_VERIFY_WINDOW_SECONDS=12
