"""Shared face quality heuristics for enrollment and recognition.

These metrics are not authentication evidence by themselves. They decide
whether a frame is trustworthy enough to feed into recognition consensus.
"""
