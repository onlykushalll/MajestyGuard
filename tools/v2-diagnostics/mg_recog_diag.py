...
def _default_v2_root() -> Path:
    ...
    for candidate in candidates:
        if (candidate / "models_insightface").exists():
            return candidate
    return candidates[0]


MODELS_DIR = _default_v2_root() / "models_insightface"
EMBEDDINGS_PATH = Path(os.environ.get("LOCALAPPDATA", "C:/tmp")) / "MajestyGuard" / "embeddings_v2.npy"
