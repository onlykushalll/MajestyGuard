...
def audit_policy(
    ...
    *,
    ...
    thresholds = {
        ...
        "soft_lock_idle_seconds": _env_float(env, "MG_IDLE_TIMEOUT", 60.0, 15.0, 600.0),
        ...
        "soft_lock_verify_window_seconds": _env_float(env, "MG_SOFT_LOCK_VERIFY_WINDOW_SECONDS", 15.0, 3.0, 60.0),
